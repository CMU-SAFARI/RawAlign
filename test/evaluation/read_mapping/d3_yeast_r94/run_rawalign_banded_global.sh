...
#if $2 is passed, use it as the band radius fraction, otherwise default to 10%
if [ ! -z "$2" ]; then
...
PRESET="sensitive"
PARAMS="--dtw-evaluate-chains --dtw-border-constraint global --dtw-fill-method banded=${BAND_RADIUS_FRACTION}"
